                ...
                if mustSolve
                    ...
                    try
                        ...
                        if !typeof(dictResults) != Dict{String, Any}
                            ...
                            println("Warning: the variable returned by a method must be of type Dict{String, Any}. Here the returned type is: ", typeof(dictResults), ". These results are ignored.")
                        end 
                    catch e
